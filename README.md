...
1.  **Develop/Test**: A developer adds or updates a secret in the **Staging** namespace of OpenBao (e.g., using CLI or UI).
2.  **Request Promotion**:
    *   Create a new branch.
...
4.  **Promote**:
    ...
    *   An Ansible playbook runs, authenticates to OpenBao, reading the secret from Staging and writing it to Production.
...
Use the provided script to set up the necessary Namespaces and AppRole:
